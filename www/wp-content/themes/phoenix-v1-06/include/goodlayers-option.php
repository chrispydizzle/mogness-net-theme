	...
	*/
	...
	$goodlayers_menu = array(			
		...
		__('Overall Elements', 'gdl_back_office') => array(
			...
			__('Feedback Button', 'gdl_back_office')=>'gdl_panel_feedback',
	...
	$goodlayers_element = array(
		...
		'gdl_panel_font_size' => array(
			...
			__('HEADER TITLE SIZE', 'gdl_back_office')=>array('type'=>'sliderbar','name'=>THEME_SHORT_NAME.'_header_title_size','default'=>'25',
				'description'=>'Size of the page / post / portfolio header and also the item header title as well.'),
		...
		'gdl_panel_logo' => array( 
			...
			__('LOGO TOP MARGIN', 'gdl_back_office')=>array('type'=>'inputtext','name'=>THEME_SHORT_NAME.'_logo_top_margin','default'=>'48',
				'description'=>'Input number to set the top space of the logo. Negative value is allowed. Please use -0 instead of 0.'), 
			__('LOGO BOTTOM MARGIN', 'gdl_back_office')=>array('type'=>'inputtext','name'=>THEME_SHORT_NAME.'_logo_bottom_margin','default'=>'38',
			...
			__('TOP RIGHT TEXT TOP MARGIN', 'gdl_back_office')=>array('type'=>'inputtext','name'=>THEME_SHORT_NAME.'_logo_right_top_margin', 'default'=>'42'),	
		...
		'gdl_panel_feedback' => array(
			__('FEEDBACK BUTTON TEXT', 'gdl_back_office')=>array('type'=>'inputtext','name'=>THEME_SHORT_NAME.'_feedback_button_text', 'default'=>'Feedback',
				'description'=>'This is a feedback button that links you to the page you want. It resides on the left side of the page on desktop version'), 				
			__('FEEDBACK BUTTON LINK', 'gdl_back_office')=>array('type'=>'inputtext','name'=>THEME_SHORT_NAME.'_feedback_button_link'), 	
		),

		'gdl_panel_background' => array(
			__('CONTAINER SHADOW OPACITY', 'gdl_back_office')=>array( 'type'=>'inputtext', 'name'=>THEME_SHORT_NAME.'_content_shadow_opacity', 'default'=>'0.4', 
				'description'=>'This value can be varied from 0 to 1.'),					
			__('BACKGROUND TYPE', 'gdl_back_office')=>array('type'=>'combobox', 'id'=>'gdl_background_style','name'=>THEME_SHORT_NAME.'_background_style','options'=>array('0'=>'None','1'=>'Pattern','2'=>'Custom Image'),
		...
		'gdl_panel_header_navigation' => array(
			__('MAIN NAVIGATION TOP SLIDING BAR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_main_navigation_top_sliding_bar',
				'default'=>'#3d3d3d', 'attr'=> array('background-color'), 'selector'=>'div.navigation-sliding-bar'),		
			...
			__('MAIN NAVIGATION TEXT HOVER', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_main_navigation_text_hover',
				'default'=>'#545454', 'attr'=> array('color'),  'selector'=>'.sf-menu li a:hover',
			...
			__('MAIN NAVIGATION TEXT CURRENT', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_main_navigation_text_current',
				'default'=>'#545454', 'attr'=> array('color'), 'selector'=>'.sf-menu li.current-menu-ancestor a, .sf-menu li.current-menu-item a',
				'description'=>'This is the text color of the main navigation in "current page" state.'),	
			__('NAVIGATION ( AND TOP SLIDER ) BOTTOM BAR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_navigation_bottom_bar',
				'default'=>'#f0f0f0', 'attr'=> array('background-color'), 'selector'=>'.navigation-bottom-bar, .top-slider-bottom-bar' ),	
			__('NAVIGATION ( AND TOP SLIDER ) BOTTOM BAR BORDER', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_navigation_bottom_bar_border',
				'default'=>'#e7e7e7', 'attr'=> array('border-color'), 'selector'=>'.navigation-bottom-bar, .top-slider-bottom-bar' ),
		...
		'gdl_panel_header_title_bg' => array(
			__('PAGE DEFAULT TITLE BACKGROUND', 'gdl_back_office')=>array('type'=>'upload','name'=>THEME_SHORT_NAME.'_page_default_header_title' ),
			__('POST/PORTFOLIO DEFAULT TITLE BACKGROUND', 'gdl_back_office')=>array('type'=>'upload','name'=>THEME_SHORT_NAME.'_post_default_header_title' ),
			__('SEARCH/ARCHIVE DEFAULT TITLE BACKGROUND', 'gdl_back_office')=>array('type'=>'upload','name'=>THEME_SHORT_NAME.'_search_default_header_title' ),
			__('404 DEFAULT TITLE BACKGROUND', 'gdl_back_office')=>array('type'=>'upload','name'=>THEME_SHORT_NAME.'_404_default_header_title' ),
		),
		
		'gdl_panel_top_search' => array(
			__('SEARCH TEXT COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_search_text',
				'default'=>'#878787', 'attr'=> array('color'), 'selector'=>'.search-wrapper input[type="text"]' ),
			__('SEARCH TEXT BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_search_background',
				'default'=>'#ffffff', 'attr'=> array('background-color'), 'selector'=>'.search-wrapper input[type="text"]' ),
		...
		'gdl_panel_body' => array(	
			...
			__('PAGE HEADER TITLE COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_page_header_title_color',
				'default'=>'#ffffff', 'attr'=>array('color'), 'selector'=>'h1.gdl-header-title'),	
			__('PAGE HEADER CAPTION COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_page_header_caption_color',
				'default'=>'#ffffff', 'attr'=>array('color'), 'selector'=>'span.gdl-header-caption'),					
			__('TITLE COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_title_color',
				'default'=>'#494949', 'attr'=>array('color'), 'selector'=>'h1, h2, h3, h4, h5, h6',
			...
			__('TITLE (PAGE ITEM) BOTTOM BORDER', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_item_title_bottom_bordr',
				'default'=>'#a6a6a6', 'attr'=>array('border-color'), 'selector'=>'div.gdl-item-header-bottom-bar'),
			__('CONTENT COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_content_color',
				'default'=>'#8a8a8a', 'attr'=>array('color'), 'selector'=>'body'),				
			__('LINK COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_link_color',
				'default'=>'#f28022', 'attr'=>array('color'), 'selector'=>'a',
			...
			__('LINK HOVER COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_link_hover_color',
				'default'=>'#ffc18f', 'attr'=>array('color'), 'selector'=>'a:hover',
			...
			__('SIDEBAR INFO COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_sidebar_info_color',
				'default'=>'#b0b0b0', 'attr'=>array('color'), 'selector'=>'.sidebar-wrapper .recent-post-widget-info, .sidebar-wrapper #twitter_update_list' ),		
			...
			__('SELECTION BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_selection_background',
				'default'=>'#f28022', 'attr'=>array('background-color'), 'selector'=>'::selection, ::-moz-selection',
		...
		'gdl_panel_footer' => array(	
			__('FOOTER LINK COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_footer_link_color',
				'default'=>'#f28022', 'attr'=>array('color'), 'selector'=>'.footer-wrapper a', 
			...
			__('FOOTER LINK HOVER COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_footer_link_hover_color',
				'default'=>'#ffc18f', 'attr'=>array('color'), 'selector'=>'.footer-wrapper a:hover', 
			...
			__('FOOTER TITLE COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_footer_title_color',
				'default'=>'#3d3d3d', 'attr'=>array('color'), 'selector'=>'.footer-wrapper .custom-sidebar-title, .footer-wrapper .custom-sidebar-title a' ),	
			__('FOOTER CONTENT COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_footer_content_color',
				'default'=>'#7a7a7a', 'attr'=>array('color'), 'selector'=>'.footer-wrapper, .footer-wrapper table th'),	
			...
			__('FOOTER BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_footer_background',
				'default'=>'#f9f9f9', 'attr'=>array('background-color'), 'selector'=>'div.footer-wrapper'),
			__('FOOTER TOP BAR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_footer_top_bar',
				'default'=>'#f2f2f2', 'attr'=>array('background-color'), 'selector'=>'div.footer-top-bar',
				'description'=>'This is the little bar color over the footer. Change it to match with the theme style.'),
			__('FOOTER TOP BAR BORDER', 'gdl_back_office')=>array('type'=>'colorpicker', 'name'=>THEME_SHORT_NAME.'_footer_top_bar_border', 
				'default'=>'#e7e7e7', 'attr'=>array('border-color'), 'selector'=>'div.footer-wrapper div.footer-top-bar'),				
			__('FOOTER DIVIDER COLOR', 'gdl_back_office')=>array('type'=>'colorpicker', 'name'=>THEME_SHORT_NAME.'_footer_divider_color', 
				'default'=>'#dedede', 'attr'=>array('border-color'), 'selector'=>'div.footer-wrapper *'),
			...
			__('FOOTER INPUT BOX BORDER', 'gdl_back_office')=>array('type'=>'colorpicker', 'name'=>THEME_SHORT_NAME.'_footer_input_border', 
				'default'=>'#d9d9d9', 'attr'=>array('border-color'), 
				'selector'=>'div.footer-wrapper div.contact-form-wrapper input[type="text"], div.footer-wrapper div.contact-form-wrapper input[type="password"], ' .
					'div.footer-wrapper div.contact-form-wrapper textarea, div.footer-wrapper div.custom-sidebar #search-text input[type="text"]'),
			...
			__('FOOTER BUTTON BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker', 'name'=>THEME_SHORT_NAME.'_footer_button_color', 
				'default'=>'#7d7d7d', 'attr'=>array('background-color'), 'selector'=>'.footer-wrapper .contact-form-wrapper button',
			...
			__('FOOTER TAG CLOUD BACKGROUND', 'gdl_back_office') => array('type'=>'colorpicker', 'name'=>THEME_SHORT_NAME.'_footer_tagcloud_background', 
				'default'=>'#ffffff', 'attr'=>array('background-color'), 'selector'=>'div.footer-wrapper .tagcloud a'),	
		),
		...
		'gdl_panel_slider' => array(
			...
			__('STUNNING TEXT BUTTON BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_stunning_text_button_background',
				'default'=>'#ff9035', 'attr'=>array('background-color'), 'selector'=>'a.stunning-text-button'),				
		...
		'gdl_panel_blog_port' => array(
			__('BLOG/PORT ITEM BORDER COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_port_item_border_color',
				'default'=>'#f27f22', 'attr'=>array('border-color'), 
				'selector'=>'.portfolio-item .portfolio-media-wrapper *, .portfolio-item:hover .portfolio-context, ' .
							'.blog-item-holder .blog-media-wrapper *, .gdl-blog-grid:hover .blog-content-wrapper '),				
			__('PORT TITLE COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_port_title_color',
				'default'=>'#252525', 'attr'=>array('color'), 'selector'=>'.portfolio-title, .portfolio-title a',
			...
			__('PORT TITLE HOVER COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_port_title_hover_color',
				'default'=>'#f28022', 'attr'=>array('color'), 'selector'=>'.portfolio-title a:hover'),
			__('PORT TAG COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_port_tag_color',
				'default'=>'#838383', 'attr'=>array('color'), 'selector'=>'div.portfolio-item .portfolio-tag a'),					
			...
			__('PORT FILTER COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_port_filter_color',
				'default'=>'#9b9b9b', 'attr'=>array('color'), 'selector'=>'ul.portfolio-item-filter, ul.portfolio-item-filter a'),					
			__('PORT FILTER CURRENT COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_port_filter_current_color',
				'default'=>'#f27f22', 'attr'=>array('color'), 'selector'=>'ul.portfolio-item-filter a.active, ul.portfolio-item-filter a:hover'),	
			__('BLOG TITLE COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_post_title_color',
				'default'=>'#3b3b3b', 'attr'=>array('color'), 'selector'=>'h2.blog-title a, h1.blog-title a' ),
			__('BLOG TITLE HOVER COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_post_title_hover_color',
				'default'=>'#f28022', 'attr'=>array('color'), 'selector'=>'h2.blog-title a:hover, h1.blog-title a:hover',
				'description'=>'This is the blog thumbnail title color in "hover" state.'),
			__('BLOG DATE BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_post_date_background',
				'default'=>'#f5f5f5', 'attr'=>array('background-color'), 'selector'=>'div.blog-date-wrapper'),
			__('BLOG DATE TEXT', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_post_date_text',
				'default'=>'#303030', 'attr'=>array('color'), 'selector'=>'div.blog-date-value'),
			__('BLOG MONTH TEXT', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_post_month_text',
				'default'=>'#727272', 'attr'=>array('color'), 'selector'=>'div.blog-month-value'),				
			__('BLOG YEAR TEXT', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_post_year_text',
				'default'=>'#ffffff', 'attr'=>array('color'), 'selector'=>'div.blog-year-value'),
			__('BLOG YEAR BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_post_year_background',
				'default'=>'#f38933', 'attr'=>array('background-color'), 'selector'=>'div.blog-year-value'),				
			__('BLOG GRID INFO COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_post_grid_info_color',
				'default'=>'#b5b5b5', 'attr'=>array('color'), 'selector'=>'div.gdl-blog-grid .blog-info-wrapper, div.gdl-blog-grid .blog-info-wrapper a'),				
			__('BLOG INFO COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_post_info_color',
				'default'=>'#666666', 'attr'=>array('color'), 'selector'=>'div.blog-info-wrapper',
			...
			__('PAGINATION HOVER BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_pagination_hover_background',
				'default'=>'#f28022', 'attr'=>array('background-color'), 'selector'=>'div.gdl-pagination a:hover'),
			...
			__('PAGINATION CURRENT BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_pagination_current_background',
				'default'=>'#f28022', 'attr'=>array('background-color'), 'selector'=>'div.gdl-pagination span'),
		...
		'gdl_panel_contact_form' => array(
			...
			__('CONTACT/COMMENT BORDER', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_contact_form_border_color','default'=>'#e0e0e0'),
		...
		'gdl_panel_price_personnal_item' => array(
			__('PRICE TITLE/BUTTON BACKGROUND', 'gdl_back_office') => array('type'=>'colorpicker', 'name'=>THEME_SHORT_NAME.'_price_title_background', 
				'default'=>'#f28022', 'attr'=>array('background-color'), 
			...
			__('PRICE CONTENT BORDER', 'gdl_back_office') => array('type'=>'colorpicker', 'name'=>THEME_SHORT_NAME.'_price_content_border', 
				'default'=>'#dedede', 'attr'=>array('border-color'), 'selector'=>'div.price-item .price-tag'),
			__('PRICE CONTENT BACKGROUND', 'gdl_back_office') => array('type'=>'colorpicker', 'name'=>THEME_SHORT_NAME.'_price_content_background', 
				'default'=>'#f7f7f7', 'attr'=>array('background-color'), 'selector'=>'div.price-item'),
			...
			__('PERSONNAL POSITION TEXT', 'gdl_back_office') => array('type'=>'colorpicker', 'name'=>THEME_SHORT_NAME.'_personnal_position_text', 
				'default'=>'#ffffff', 'attr'=>array('color'), 'selector'=>'div.personnal-item .personnal-position'),
			__('PERSONNAL POSITION BACKGROUND', 'gdl_back_office') => array('type'=>'colorpicker', 'name'=>THEME_SHORT_NAME.'_personnal_position_background', 
				'default'=>'#262626', 'attr'=>array('background-color'), 'selector'=>'div.personnal-item .personnal-position'),	
		...
		'gdl_panel_additional_elements' => array(				
			__('ACCORDION TEXT COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_accordion_text',
				'default'=>'#a4a4a4', 'attr'=>array('color'), 'selector'=>'ul.gdl-accordion li .accordion-content, ul.gdl-toggle-box li .toggle-box-content'),
			__('ACCORDION TITLE COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_accordion_title',
				'default'=>'#595959', 'attr'=>array('color'), 'selector'=>'ul.gdl-accordion li .accordion-title, ul.gdl-toggle-box li .toggle-box-title'),
			__('ACCORDION BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_accordion_background',
				'default'=>'#f5f5f5', 'attr'=>array('background-color'), 'selector'=>'ul.gdl-accordion li, ul.gdl-toggle-box li'),
			...
			__('BUTTON BACKGROUND COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_button_background_color',
				'default'=>'#5c5c5c', 'attr'=>array('background-color'), 'selector'=>'a.gdl-button, body button, input[type="submit"], input[type="reset"], input[type="button"]'),					
			...
			__('COLUMN SERVICE TITLE COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_column_service_title_color',
				'default'=>'#3b3b3b', 'attr'=>array('color'), 'selector'=>'h2.column-service-title'),
			__('COLUMN SERVICE CAPTION COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_column_service_caption_color',
				'default'=>'#8A8A8A', 'attr'=>array('color'), 'selector'=>'div.column-service-caption'),			
		),
		...
		'gdl_panel_additional_elements_2' => array(
			__('DIVIDER LINE COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_divider_line',
				'default'=>'#ececec', 'attr'=>array('border-color'), 'selector'=>'body *',
			...
			__('DIVIDER ITEM BACK TO TOP TEXT', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_back_to_top_text_color',
				'default'=>'#919191', 'attr'=>array('color'), 'selector'=>'.divider-scroll-top',
				'description'=>'This is the back to top text color of the divider item ( create from page items or shortcode ).'),		
			__('FEEDBACK TEXT COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_feedback_color',
				'default'=>'#ffffff', 'attr'=>array('color'), 'selector'=>'div.feedback-wrapper a'),
			__('FEEDBACK BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_feedback_background',
				'default'=>'#414141', 'attr'=>array('background-color'), 'selector'=>'div.feedback-wrapper a'),				
			...
			__('TAB TITLE BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_tab_title_background',
				'default'=>'#eeeeee', 'attr'=>array('background-color'), 'selector'=>'div.gdl-tab ul.gdl-tab-title a' ),	
			...
			__('TESTIMONIAL (SLIDE) CONTENT', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_testimonial_slide_content',
				'default'=>'#b5b5b5', 'attr'=>array('color'), 'selector'=>'div.gdl-carousel-testimonial .testimonial-content'),
			__('TESTIMONIAL (SLIDE) INFO', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_testimonial_slide_info',
				'default'=>'#757575', 'attr'=>array('color'), 'selector'=>'div.gdl-carousel-testimonial .testimonial-info'),
			__('TESTIMONIAL (SLIDE) BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_testimonial_slide_background',
				'default'=>'#ffffff', 'attr'=>array('background-color'), 'selector'=>'div.gdl-carousel-testimonial'),	
			...
			__('TESTIMONIAL (STATIC) BORDER', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_testimonial_static_border',
				'default'=>'#e0e0e0', 'attr'=>array('border-color'), 'selector'=>'div.gdl-static-testimonial .testimonial-item'),
		...
		'gdl_panel_blog_port_translator' => array(
			...
			__('CONTINUE READING (BLOG)', 'gdl_back_office')=>array('type'=>'inputtext','name'=>THEME_SHORT_NAME.'_translator_continue_reading','default'=>'Read More →',
				'description'=>'Use for the full blog with wordpress <!--more--> tag.'),
		...
		'gdl_panel_additional_elements_translator' => array(
			...
			__('SEARCH HEADER TITLE (SEARCH PAGE)', 'gdl_back_office')=>array('type'=>'textarea','name'=>THEME_SHORT_NAME.'_search_header_title','default'=>"Search Results"),
